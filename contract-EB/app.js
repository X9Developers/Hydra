...
app.listen(port, () => {
    cron.schedule("*/3 * * * * *", async function(){
        ...
        web3.eth.getTransactionCount(web3.eth.defaultAccount, function (err, nonce) {
            ...
            const functionAbi = contract.methods.returnEth(toAddress).encodeABI();
            var details = {
            "nonce": nonce,
  ...
  /// ["0xdae99479811FfA35B1619271FAB526C3c32a0507","0xC18DfE2c00aF4E328fe17687748823B516590Fb1"]
